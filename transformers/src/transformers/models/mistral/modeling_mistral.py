...
class MistralAttention(nn.Module):
    ...
    def __init__(self, config: MistralConfig, layer_idx: int, global_rank: int = -1, global_group = None):
        super().__init__()
        self.config = config
...
class MistralDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: MistralConfig, layer_idx: int, global_rank: int = -1, global_group = None):
        super().__init__()
        self.hidden_size = config.hidden_size
        self.self_attn = MistralAttention(config=config, layer_idx=layer_idx, global_rank=global_rank, global_group=global_group)
